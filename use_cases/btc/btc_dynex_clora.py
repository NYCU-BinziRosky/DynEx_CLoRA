...
def train_and_validate_lora(student_model, teacher_model, stable_classes, output_size, criterion, optimizer, 
    ...
    similarity_threshold = 0.0  # Set to 0.0 as per request
...
train_and_validate(
    ...
    scheduler, use_scheduler=False, num_epochs=2000, batch_size=64,
    model_saving_folder=model_saving_folder, model_name="BiGRUWithAttention",
...
class_features_dict = train_and_validate_lora(
    ...
    X_train, y_train, X_val, y_val, scheduler, False, 2000, 64, alpha,
    model_saving_folder, "BiGRUWithAttention", stop_signal_file,
    class_features_dict=task_features, tau_high=0.5, tau_low=0.5,
