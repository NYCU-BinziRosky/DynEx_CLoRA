...
# ================================
# 🔧 Training Function for MSE Distillation on ECG Dataset
# ================================
def train_with_mse_ecg(
    student_model,
    output_size,
    criterion,
    optimizer,
    ...
    print("\n🚀 Starting ECG training with MSE Distillation...")
    ...
    for epoch in range(num_epochs):
        ...
        for X_batch, y_batch in train_loader:
            ...
            if teacher_model and stable_classes:
                ...
                student_stable = student_logits.index_select(dim=1, index=indices)
                teacher_stable = teacher_logits.index_select(dim=1, index=indices)
    ...
    print("\n---")
    print(f"### Period {period_label} (alpha = {alpha})")
    print(f"+ Training time : {training_time:.2f} seconds")
